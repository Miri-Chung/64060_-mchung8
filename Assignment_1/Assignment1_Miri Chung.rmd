...
**Solution:**
```{r}
setwd("D:\\Cloud\\Kent_Google Drive\\Kent Class\\MIS 64060 Fundamentals of Machine Learning\\Assignment\\Assignment 1") #set the working directory
library(readr)
mydata <- read_csv("D:/Cloud/Kent_Google Drive/Kent Class/MIS 64060 Fundamentals of Machine Learning/Assignment/Assignment 1/NFWBS_PUF_2016_data.csv") # rename the dataset for the future reference
```
...
```{r}
library(dplyr)
mydata$MILITARY<-recode(mydata$MILITARYHistory, "Refused"=-1, "No"=0, "Yes"=1) # record string value of MILITARYhistory to numeric value
